<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'p3plzcpnl467527.prod.phx3.secureserver.net'; //Modificar
		$mail->Port = 587; //Modificar
		
		$mail->Username = 'no-reply@vanesagomez.club'; //Modificar
		$mail->Password = 'NiZ0%[#*,l=W'; //Modificar
		
		$mail->setFrom('no-reply@vanesagomez.club', 'Sistema De Vanesa CLUB'); //Modificar
